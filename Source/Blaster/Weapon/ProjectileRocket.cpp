...
{
	RocketMeshComponent = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Rocket Mesh"));
                              ...
                              FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if (RocketMeshComponent)
	{
		RocketMeshComponent->SetVisibility(false);
	}
	if (CollisionBox)
	{
